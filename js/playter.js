...
let i = 0;
export function drawPlayer(eyePlayer, leftImages, rightImages, jumpLeftImage, jumpRigthImage) {
    c.save();
    c.fillStyle = "black";
    if (rightImage) {
        ...
        c.drawImage(jumpRigthImage, player.x, player.y, player.width, player.height);
    }
    else {
